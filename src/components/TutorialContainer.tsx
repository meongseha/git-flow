    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="col-span-1">
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-semibold mb-4" id="tutorial">Tutorial Steps</h2>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex items-center">
                  <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-white border border-gray-300 mr-3">
                    {index + 1}
                  </span>
                  {step.title}
                </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mt-6">
          <h2 className="text-xl font-semibold mb-4" id="reference">Command Reference</h2>
          <CommandReference currentStep={currentStep} />
        </div>
      </div>

      <div className="col-span-1 lg:col-span-2">
        <div className="bg-white rounded-lg shadow p-6 mb-6" id="visualization">
          <h2 className="text-xl font-semibold mb-4">Git Flow Visualization</h2>
          <GitFlowVisualization currentStep={currentStep} currentBranch={currentBranch} />
        </div>

        <div className="bg-white rounded-lg shadow p-6" id="practice">
